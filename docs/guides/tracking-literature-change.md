...
```python
sf.extract_dois(["https://doi.org/10.1/A", "doi: 10.1/a", "10.2/B"])
```
...
restored = sf.read_parquet("baseline.parquet") if False else __import__("pandas").read_parquet("baseline.parquet")
