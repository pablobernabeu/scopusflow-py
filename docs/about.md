...
> pybliometrics for Scopus searches. Python package version 0.3.0.
...
and the
[contributing guide](https://github.com/pablobernabeu/scopusflow-py/blob/main/CONTRIBUTING.md)
